...
#request setbufscale 1
	'';
	  ...
	  workspace = 10, monitor:eDP-1, default:true, on-created-empty: kitty -e cmatrix & sleep 0.05; kitty -e asciiquarium & sleep 0.05 ; kitty -e cbonsai -li & sleep 0.05; kitty -e pipes.sh & sleep 0.05; kitty -e nohup glava
	...
	# Controles de media
	  ...
	  env = QT_QPA_PLATFORMTHEME,qt5ct
        ...
        '';
        ".config/rofi/arc_dark_colors_rasi".text = ''
          //- file:rofi/arc_dark_colors.rasi
          /*******************************************************
        ...
        '';
        ".config/rofi/arc_dark_transparent_colors.rasi".text = ''
          //- file:rofi/arc_dark_transparent_colors.rasi
          /*******************************************************
